...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    try {
      flutterEngine.getPlugins().add(new dk.nota.flutter_readium.FlutterReadiumPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin flutter_readium, dk.nota.flutter_readium.FlutterReadiumPlugin", e);
    }
    try {
